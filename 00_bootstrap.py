...
!hdfs dfs -mkdir -p $STORAGE/data
!hdfs dfs -mkdir -p $STORAGE/data/LendingClub
!hdfs dfs -copyFromLocal /home/cdsw/data/LoanStats_2015_subset_071821.csv $STORAGE/data/LendingClub/LoanStats_2015_subset_071821.csv
